...
// Query: *[_type == "article" && translationGroupId == $translationGroupId && !archived && !withdrawn && language in ["ru", "ro", "uk"] && defined(slug.current)]  { "slug": slug.current, language, primaryDomain, sourceMedicalRevision, "sourceCurrentMedicalRevision": translatedFrom->medicalRevision }
