...
1. `Product Blueprint v1.1.md`
2. `Content & UX Freeze v1.0.md`
3. `POLINA_VET_High_Fidelity_Prototype_v1.2_FROZEN.html`
4. `POLINA_VET_Prototype_v1.2_Decision_Log.md`
5. `POLINA_VET_Prototype_Handoff_v1.2_CODEX_READY.md`
