...
**M10 deferred QA:** CLOSED / PASS
**FINAL DOMAIN ACTIVATION:** moved to [R1 — Final Domain & Public Launch Activation](R1_FINAL_DOMAIN_ACTIVATION.md)
**Preferred future final domain:** `lina.vet`
**Public SEO launch:** NOT YET ACTIVATED
**M12:** ready after M11 merge; not started.
...
Future final production hostname: `lina.vet` — not yet owned; activation is tracked in [R1](R1_FINAL_DOMAIN_ACTIVATION.md).
...
Future activation requires owner purchase/control of `lina.vet`. No domain purchase, indexing, Search Console submission, or v1.0.0 tag is authorized in M11. The temporary candidate does not depend on owning the final domain. **R1 remains open; M11 is closed.**
